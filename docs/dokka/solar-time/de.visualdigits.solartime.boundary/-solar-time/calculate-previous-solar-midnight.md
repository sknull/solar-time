//[solar-time](../../../index.md)/[de.visualdigits.solartime.boundary](../index.md)/[SolarTime](index.md)/[calculatePreviousSolarMidnight](calculate-previous-solar-midnight.md)
